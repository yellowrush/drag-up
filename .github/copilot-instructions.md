# Drag Up Copilot Instructions

This repository is a uni-app / WeChat puzzle game. Kid idea issues come from the
Drag Up kid idea box.
...
- Do not merge PRs into `develop`; the maintainer decides when to merge.
