...
export class GameEngine {
  ...
  render() {
    ...
    // Render maze
    this.maze.render(this.ctx, this.mazeCenter, this.gridSize, this.maze.flyWheel.angle)
    ...
    this.cub.render(this.ctx, this.mazeCenter, this.gridSize, this.maze.flyWheel.angle, isHovered)
  }
  ...
  renderRotateHandle() {
    ...
    var pieDirection = normalizeAngle(normalizeAngle(this.moveAngle) - normalizeAngle(this.dragStartAngle)) > TAU / 2
    this.ctx.arc(this.mazeCenter.x, this.mazeCenter.y, pieRadius, this.dragStartAngle, this.moveAngle, pieDirection)
  ...
  handlePointerUp(event) {
    ...
    if (this.pointerBehavior === 'cubDrag') {
      ...
      this.mazeRotatePointerUp(pointer)
    }
  ...
  cubDragPointerUp() {
    ...
    if (this.cub.peg.x == this.maze.goalPosition.x &&
